      ...
      <Container className="flex flex-col lg:flex-row gap-10 lg:gap-12">
        ...
        >
          ...
          <Paragraph className="mt-8">
            ...
            commodi, architecto soluta tempore dolor aliquid molestiae tempora
            est, autem suscipit aspernatur vitae reiciendis ea consequuntur
            optio eos minima magni.
          </Paragraph>
          ...
          <div className="mt-10 w-full flex max-w-md mx-auto lg:mx-0 ">
            <div className="flex sm:flex-row flex-col gap-5 w-full">
              <form
                action="#"
                className="py-1 pl-6 w-full pr-1 flex gap-3 items-center text-heading-3 shadow-lg shadow-box-shadow border border-box-border
